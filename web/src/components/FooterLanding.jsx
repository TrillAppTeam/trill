  ...
  return (
    <footer>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 bg-trillPurple pt-5">
        ...
        <div className="grid grid-cols-2 border-t border-gray-400 pt-5 pb-5 ">
          ...
          <div className="flex justify-center">
            <div className="">
              <h6 className="font-bold text-gray-300 text-md sm:text-lg mb-2">Contact Us</h6>
              <ul className="text-sm sm:text-md text-gray-300">
